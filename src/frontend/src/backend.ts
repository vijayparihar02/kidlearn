...
export class Backend implements backendInterface {
    ...
    async getAlphabet(): Promise<Array<AlphabetEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAlphabet();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAnimals(): Promise<Array<AnimalEntry>> {
        if (this.processError) {
            try {
    ...
    async getNumbers(): Promise<Array<NumberEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getNumbers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
